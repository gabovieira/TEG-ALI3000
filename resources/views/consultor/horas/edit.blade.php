...
@section('title', 'Editar Registro de Horas - ALI3000')

@section('consultor-content')
<div class="mb-6">
    <h1 class="text-2xl font-bold text-[#000000]">Editar Registro de Horas</h1>
    <p class="text-[#708090]">Modifica tu registro de horas trabajadas</p>
</div>
...
<div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
    ...
    @else
        <form action="{{ route('consultor.horas.update', $registro->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <input type="date" id="fecha" name="fecha" value="{{ old('fecha', $registro->fecha->format('Y-m-d')) }}" 
                       max="{{ date('Y-m-d') }}"
        ...
        <div class="mb-6">
            ...
            <div class="flex items-center">
                <input type="number" id="horas_trabajadas" name="horas_trabajadas" value="{{ old('horas_trabajadas', $registro->horas_trabajadas) }}" 
        ...
        <div class="mb-6">
            ...
            <textarea id="descripcion_actividades" name="descripcion_actividades" rows="4"
                      class="w-full rounded-md border-gray-300 shadow-sm focus:border-[#4682B4] focus:ring focus:ring-[#4682B4] focus:ring-opacity-50" required>{{ old('descripcion_actividades', $registro->descripcion_actividades) }}</textarea>
        ...
        <div class="bg-gray-50 p-4 rounded-lg mb-6">
            ...
            <ul class="text-xs text-gray-600 space-y-1 list-disc list-inside">
                <li>Solo puedes editar registros en estado "pendiente"</li>
