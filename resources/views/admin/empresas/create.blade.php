...
@section('title', 'Crear Empresa - ALI3000')
...
@section('admin-content')
    <div class="mb-6 flex justify-between items-center">
        <div>
            ...
            <p class="text-gray-600">Ingrese los datos de la nueva empresa</p>
        </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <select name="tipo_empresa" id="tipo_empresa" required
                                ...
                                <option value="S.A." {{ old('tipo_empresa') == 'S.A.' ? 'selected' : '' }}>S.A.</option>
                                <option value="C.A." {{ old('tipo_empresa') == 'C.A.' ? 'selected' : '' }}>C.A.</option>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <textarea name="direccion" id="direccion" rows="3"
                                      class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50">{{ old('direccion') }}</textarea>
                        </div>
                        ...
                        @foreach($consultores as $consultor)
                            <div class="flex items-center">
                                <input type="checkbox" name="consultores[]" id="consultor-{{ $consultor->id }}" value="{{ $consultor->id }}"
                                       ...
                                       {{ in_array($consultor->id, old('consultores', [])) ? 'checked' : '' }}>
