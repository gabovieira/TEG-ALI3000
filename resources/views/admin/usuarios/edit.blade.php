...
@section('title', 'Editar Usuario - ALI3000')
                ...
                <div>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" name="nombre" id="nombre" value="{{ old('nombre', $usuario->primer_nombre) }}" required
                        ...
                        <div>
                            ...
                            <input type="text" name="apellido" id="apellido" value="{{ old('apellido', $usuario->primer_apellido) }}" required
                                   class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50">
                        </div>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <select name="tipo_usuario" id="tipo_usuario" required
                                    class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50">
                                <option value="consultor" {{ old('tipo_usuario', $usuario->tipo_usuario) == 'consultor' ? 'selected' : '' }}>Consultor</option>
                        ...
                        <div>
                            ...
                            <select name="estado" id="estado" required
                                ...
                                <option value="pendiente_registro" {{ old('estado', $usuario->estado) == 'pendiente_registro' ? 'selected' : '' }}>Pendiente de Registro</option>
                            </select>
                        </div>
                        ...
                        @foreach($empresas as $empresa)
                            <div class="flex items-center">
                                <input type="checkbox" name="empresas[]" id="empresa-{{ $empresa->id }}" value="{{ $empresa->id }}"
                                       ...
                                       {{ in_array($empresa->id, old('empresas', $empresasAsignadas)) ? 'checked' : '' }}>
