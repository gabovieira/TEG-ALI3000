...
<div class="flex min-h-screen">
    <!-- Sidebar -->
    <aside class="bg-black text-white w-64 flex-shrink-0 hidden md:flex flex-col justify-between py-8 px-4">
        <div>
            <div class="flex items-center mb-10">
                <div class="w-10 h-10 rounded-full bg-gradient-to-tr from-blue-500 to-green-400 flex items-center justify-center text-2xl font-bold mr-3">A</div>
                <span class="text-xl font-semibold tracking-wide">ALI 3000</span>
            </div>
            <nav class="space-y-2">
                <a href="#" class="flex items-center px-3 py-2 rounded-lg hover:bg-gray-800 transition group font-medium"><span class="mr-3">🏠</span>Dashboard</a>
                <div class="ml-2 text-xs text-gray-400 mt-4 mb-1">Usuarios</div>
                <a href="#" class="flex items-center px-3 py-2 rounded-lg hover:bg-gray-800 transition group"><span class="mr-3">👥</span>Consultores</a>
                <a href="#" class="flex items-center px-3 py-2 rounded-lg hover:bg-gray-800 transition group"><span class="mr-3">🧑‍💼</span>Validadores</a>
                <a href="#" class="flex items-center px-3 py-2 rounded-lg hover:bg-gray-800 transition group"><span class="mr-3">🏢</span>Empresas</a>
                <a href="#" class="flex items-center px-3 py-2 rounded-lg hover:bg-gray-800 transition group"><span class="mr-3">⏰</span>Gestión de Horas</a>
                <a href="#" class="flex items-center px-3 py-2 rounded-lg hover:bg-gray-800 transition group"><span class="mr-3">💰</span>Pagos</a>
                <a href="#" class="flex items-center px-3 py-2 rounded-lg hover:bg-gray-800 transition group"><span class="mr-3">📊</span>Reportes</a>
                <a href="#" class="flex items-center px-3 py-2 rounded-lg hover:bg-gray-800 transition group"><span class="mr-3">⚙️</span>Configuración</a>
                <a href="#" class="flex items-center px-3 py-2 rounded-lg hover:bg-gray-800 transition group"><span class="mr-3">📱</span>Notificaciones</a>
            </nav>
        </div>
    ...
    <main class="flex-1 flex flex-col">
        ...
        <header class="flex items-center justify-between px-6 py-4 bg-white border-b border-gray-200 shadow-sm">
            <div class="flex items-center space-x-4">
                <span class="text-lg font-bold text-gray-900 hidden md:inline">Dashboard</span>
            </div>
            <div class="flex items-center space-x-6">
                <div class="flex items-center space-x-2 bg-gray-100 px-3 py-1 rounded-lg">
                    <span class="text-blue-600 font-bold">Tasa BCV:</span>
                    <span class="font-semibold">36,25 Bs/USD</span>
                    <span class="text-xs text-gray-500 ml-2">hace 2h</span>
                </div>
                <button class="relative focus:outline-none">
                    <span class="absolute -top-1 -right-1 bg-red-500 text-white text-xs rounded-full px-1.5 py-0.5 font-bold">3</span>
                    <span class="text-2xl">🔔</span>
                </button>
                <div class="flex items-center space-x-2 bg-gray-100 px-3 py-1 rounded-lg">
                    <div class="w-8 h-8 rounded-full bg-gray-700 flex items-center justify-center text-lg font-bold text-white">AD</div>
        ...
        <div class="flex-1 p-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                <div class="bg-white p-4 rounded-lg shadow-md flex flex-col">
                    ...
                    <div class="text-2xl font-bold" id="consultores-activos">--</div>
