...
<div class="flex min-h-screen">
    <!-- Sidebar Moderno -->
<aside class="bg-white border-r border-gray-200 w-64 min-h-screen flex flex-col justify-between py-6 px-4">
    <div>
...
<nav class="space-y-1">
    ...
    <a href="#" class="flex items-center px-3 py-2 rounded-lg hover:bg-gray-100 transition">
        ...
        Usuarios
        <span class="ml-auto text-xs bg-gray-200 text-gray-700 rounded-full px-2 py-0.5 font-bold">124</span>
    </a>
    <a href="#" class="flex items-center px-3 py-2 rounded-lg hover:bg-gray-100 transition">
        <!-- User Cog (Lucide) -->
        ...
        Consultores
        <span class="ml-auto text-xs bg-gray-200 text-gray-700 rounded-full px-2 py-0.5 font-bold">45</span>
    </a>
    <a href="#" class="flex items-center px-3 py-2 rounded-lg hover:bg-gray-100 transition">
        <!-- Shield (Lucide) -->
        ...
        Validadores
        <span class="ml-auto text-xs bg-gray-200 text-gray-700 rounded-full px-2 py-0.5 font-bold">12</span>
    </a>
    <a href="#" class="flex items-center px-3 py-2 rounded-lg hover:bg-gray-100 transition">
        <!-- Building (Lucide) -->
...
$db = getDbConnection(); // Debes tener una función getDbConnection() en database.php
$tasaService = new TasaBCVService($db);
